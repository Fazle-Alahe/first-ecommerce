            ...
            <div class="card-body">
                <form action="{{route('special.offer.store')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" name="discount_price" value="">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{route('special.offer2.store')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        <label for="" class="form-label">Product Name</label>
                        <input type="text" class="form-control" name="product_name2" value="">
                        @error('product_name2')
                            <strong class="text-danger">{{$message}}</strong>
                        @enderror
                    </div>
                    <div class="mb-3">
                        ...
                        <label for="" class="form-label">Discount Price</label>
                        <input type="number" class="form-control" name="discount_price2" value="">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="my-2">
                            <img width="200" id="blah2" src="" alt="">
                        </div>
                    </div>
                    <div class="mb-3">
