                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control border-0 px-0" id="input-tags" name="tags[]">
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <div class="mb-3">
                        ...
                        <div class="col-lg-6 m-auto">
                            <div class="mb-3">
                                <button type="submit" class="btn btn-primary w-100 upload__btn btn_design">Add Product</button>
                            </div>
                        </div>
                    </div>
                </form>
