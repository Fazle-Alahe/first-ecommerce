...
<div class="row py-5">
    <div class="col-lg-8 m-auto">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{route('order.cancel.req', $order_info->id)}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
                        <label class="form-label">Cancel Reason</label>
                        <textarea name="reason" class="form-control" cols="30" rows="10"></textarea>
                        @error('reason')
                            <strong class="text-danger">Enter the reason of order cancellation.</strong>
                        @enderror
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <button type="submit" class="btn greeenn">Send Request</button>
                    </div>
                </form>
            </div>
        </div>
